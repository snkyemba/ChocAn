...
public class WeeklyReportGenerator {
    ...
    public void generateSummaryReport() {
        try (FileWriter myWriter = new FileWriter("summaryReport.txt")) {
    ...
    public void generateMemberReport(FileWriter myWriter) {
        ...
        try {
            //FileWriter myWriter = new FileWriter("summaryReport.txt");
            myWriter.write("Member Reports\n\n");
     ...
     *
     */
    public void generateManagerReport(FileWriter myWriter) {
     ...
     *
     */
    public void generateProviderReport(FileWriter myWriter) {
        int numConsults = 0;
        ...
        try {
            ...
            myWriter.write("Provider Reports\n\n");
            for (int i = 0; i < vector.size(); i++) {
